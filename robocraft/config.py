...
parser.add_argument('--resume_from', type=str, default='', help='multimaterial: continue a finished run dir (net_final, epoch_log, net_best) up to --n_epoch in a new outf')
